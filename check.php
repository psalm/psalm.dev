...
$config->ignore_internal_nullable_issues = isset($_POST['strict_internal_functions']) ? !$_POST['strict_internal_functions'] : true;
$config->ignore_internal_falsable_issues = isset($_POST['strict_internal_functions']) ? !$_POST['strict_internal_functions'] : true;
