...
$config->ignore_internal_nullable_issues = !($_POST['strict_internal_functions'] ?? false);
$config->ignore_internal_falsable_issues = !($_POST['strict_internal_functions'] ?? false);
