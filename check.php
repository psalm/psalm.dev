...
$config->ignore_internal_nullable_issues = (bool) ($_POST['strict_internal_functions'] ?? false);
$config->ignore_internal_falsable_issues = (bool) ($_POST['strict_internal_functions'] ?? false);
